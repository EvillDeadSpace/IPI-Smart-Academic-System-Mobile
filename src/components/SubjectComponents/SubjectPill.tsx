...
import { filterSubjectPill } from '../../constants/const';
import { SubjectPillsProps } from '../../types/SubjectTypes';

const SubjectPill = ({ active, onChange, counts }: SubjectPillsProps) => {
